          ...
          <div className="max-w-xl w-full">
            <body>
              <button
                ...
                onClick={onCancel}
                class=" bg-red-600 close inline-block roundedpx-6 pb-2 pt-2.5 text-xs font-medium uppercase leading-normal text-white shadow-primary-3 transition duration-150 ease-in-out hover:bg-primary-accent-300 hover:shadow-primary-2 focus:bg-primary-accent-300 focus:shadow-primary-2 focus:outline-none focus:ring-0 active:bg-primary-600 active:shadow-primary-2 motion-reduce:transition-none dark:shadow-black/30 dark:hover:shadow-dark-strong dark:focus:shadow-dark-strong dark:active:shadow-dark-strong">
                &times;
              </button>
              <h5 class="mb-6 text-blue-gray mt-10 ml-4 text-xl font-medium leading-tight text-primary">
                Are you sure you want to delete this inventory?
              </h5>
              <br />
              <h6 class="mb-2 text-blue-gray mt-0 text-base font-medium leading-tight text-primary">
